	...
	render() {
		return (
			<Fragment class="nav-bar">
				...
				<Row align = "middle" >
          <Col span={3}>
            <a href="#"><GithubFilled id="git-icon" ></GithubFilled></a>
          </Col>
					<Col span={10} id = "input-col">
            <Input id="search-input" value={this.props.value} onChange={this.handleChange} 
            suffix={
              <Tooltip title="Search for a repository in github" color="#ffffffb3">
